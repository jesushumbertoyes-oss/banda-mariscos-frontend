...
const HeroSection = ({ bandInfo }) => {
  const foundedYear = bandInfo?.founded_date 
    ? new Date(bandInfo.founded_date).getFullYear() 
    : '2020';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="inline-block bg-mariscos-800/80 border border-brass/30 rounded-lg px-6 py-3">
          <span className="text-brass font-display text-xl tracking-wide">
            DESDE {foundedYear}
          </span>
        </div>
